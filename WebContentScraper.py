...
if __name__ == '__main__':
    website_url = 'https://sites.google.com/view/vihaan-saxena'  # Replace with your website URL
    content = scrape_website(website_url)

    if content:
        # Store the scraped content into a JSON file
        file_name = 'vihaan-homepage.json'
        ...
        # Example usage
        response = answer_question_from_file("I'm Vihaan Saxena", "vihaan-homepage.json")
        print(response)